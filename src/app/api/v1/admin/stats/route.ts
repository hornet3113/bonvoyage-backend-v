  ...
  try {
    ...
    const result = await db.query(`
      SELECT
        ...
        (SELECT COUNT(*) FROM tickets WHERE estado_presupuesto = 'EXCEDIDO')                       AS tickets_excedidos,
        (SELECT COUNT(*) FROM tickets WHERE estado_presupuesto = 'ADVERTENCIA')                    AS tickets_advertencia,
